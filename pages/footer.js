...
const Footer = () => {
  ...
  return (
    ...
    >
      <p>
        <b>Weighted Shortest Job First</b> is a prioritisation technique that
        helps teams to prioritise their work based on the cost of delay.
      </p>
      <p>
        For more details see these great articles at{" "}
        <a
        ...
        and{" "}
        <a
          href="https://scaledagileframework.com/wsjf/"
          style={{ color: "#222222" }}
        >
          SAFe
        </a>
      ...
      <p>
        &copy; {year}{" "}
        <a href="https://sprout.co.id/id" style={{ color: "#222222" }}>
          Sprout
        </a>
      </p>
