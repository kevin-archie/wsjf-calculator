  ...
  const columns = [
    {
      ...
      render: (text, record) => (
        <Input
          value={text}
          onChange={(e) =>
            handleValueChange(e.target.value, record.id, "issue_key")
          }
        />
      ),
    },
        ...
        <WavyBackground>
          ...
          >
            ...
            >
              ...
              >
                Enter the issue key of the Jira Epic or Story to fetch its
                children tasks.
              </Text>
              <Form form={form}>
                <Form.Item
                      ...
                      !isCheckingParentIsError ? (
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            ...
                            const issueKey =
                              form.getFieldValue("parentIssueKey");
              ...
              {!isRemoveErrorMessage && (
                ...
                >
                  {isCheckingParentIsError && (
                    <Text type="danger">
                      Issue type should be a Epic or Story
                    </Text>
                  )}
                  {isIssueKeyParentNotFound && (
            ...
            >
              <p className="modal-subtitle">
                Get Unlimited digital access free for one month Unlimited
                Digital Access
              </p>
              <Button
                type="primary"
              ...
              <a
                ...
                onClick={() => setIsPaywallVisible(false)}
              >
